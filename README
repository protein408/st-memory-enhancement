...
<div align="center">
    ...
    <img src="https://github.com/user-attachments/assets/e46e2293-56f3-40bc-8722-21d52a09ec76" alt="플러그인 인터페이스 모바일 예시" style="max-width:70%;">
</div>
...
<ol>
    ...
    <li><b>플러그인 주소 입력:</b> 팝업 창에서 플러그인의 GitHub 주소 <code>https://github.com/protein408/st-memory-enhancement-kr.git</code>를 입력한 다음 <code>Install for all users</code>를 선택합니다.</li>
</ol>
